    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="text-xl text-gray-300 leading-8 max-w-3xl mx-auto">
          Strategi hukum yang tepat, integritas yang teguh,
          dan pendampingan profesional untuk melindungi
          kepentingan setiap klien.
        </p>
        ...
        <div className="mt-12 flex flex-col sm:flex-row justify-center gap-5">
          ...
          <Link
            href="#layanan"
            className="border-2 border-yellow-500 text-yellow-400 font-bold px-8 py-4 rounded-full hover:bg-yellow-500 hover:text-black transition"
          >
            Bidang Praktik
          </Link>
